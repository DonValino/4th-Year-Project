...
$content = $userController->GetAllInactiveUsersContent();
...
if($epr=='activate')
{
    ...
    $userController->updateAccountStateActive(1, $id);
    header('Location: AdminInactiveUserAccount.php?epr=activated');
}

if($epr=='activated')
{
    $errorMessage = "<p style='color:green;font-size:16px;'>Account Activated :)</p>";
}
