...
$content = $userController->GetAllActiveUsersContent();
...
if($epr=='deactivate')
{
    ...
    $userController->updateAccountStateActive(0, $id);
    header('Location: AdminActiveUserAccount.php?epr=deactivated');
}

if($epr=='deactivated')
{
    $errorMessage = "<p style='color:green;font-size:16px;'>Account Deactivated</p>";
}
