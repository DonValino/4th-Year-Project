...
$content = '<div class="row col-md-6 col-sm-6 col-sm-offset-3" style="background-color:white; margin-bottom:10px;">
                ...
                <div id="collapseadvertisedjobs" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <div class="row col-md-offset-3 col-sm-offset-3">
                            <form action="UpgradeToFeature_charge.php" method="POST">
                                <script
