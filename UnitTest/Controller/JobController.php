				...
				<div class='modal-body'>
                                <div class='row'>
                                    <div id='register' class='register-form'>
                                             ...
                                             <form action='' method = 'POST'>
                                             <div class='row'>
                                                <input type='radio' onclick = 'fullTimeBid()' style='margin-left:38%; margin-bottom:20px;' name='gender' value='0' required> Full Time 
  ...
  function codeAddress() {
   ...
   // View the Job Details
    ...
    function InsertAJob($id)
    {
        ...
        $job = new JobEntities(-1, $name, $description, $type, $qualification, $address, $county, $numberOfDays, $numberOfPeopleRequired, $price, $isActive, $id, $dateTime,$startDate);
        $jobModel = new JobModel();
